...
use Snowflake\Varnish\Utilities\VarnishGeneralUtility;
use TYPO3\CMS\Core\Utility\GeneralUtility;
use Snowflake\Varnish\Utilities\Http;
...
class VarnishController
{
    ...
    public function clearCache($cacheCmd)
    {
        ...
        // all other Commands ("page", "all") lead to a BAN of the whole Cache
        $command = array (
            MathUtility::canBeInterpretedAsInteger($cacheCmd) ? 'Varnish-Ban-TYPO3-Pid: ' . $cacheCmd : 'Varnish-Ban-All: 1',
        ...
        /** @var $varnishHttp \Snowflake\Varnish\Utilities\Http */
        $varnishHttp = GeneralUtility::makeInstance(Http::class);
